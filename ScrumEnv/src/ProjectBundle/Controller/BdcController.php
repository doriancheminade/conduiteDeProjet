...
class BdcController extends Controller
{
  ...
  public function bdcAction($owner, $project, $sprintId) {
    ...
    /*$em = $this->container->get('doctrine')->getEntityManager();
      ...
      */
      ...
      $costtask = $em->getRepository('ProjectBundle:Task')
      ->findBy(
        array('owner' => $owner,
          'project' => $project
                  ));     //these are the parameters for the search 
                          // this is to order the list
    ...
    //This gets passed to the browser and displayed.
      ...
      $redirect = $this->render('ProjectBundle:Sprint:bdc.html.twig', array(
        'EncodedImage' => $image, 'sprintId' => $sprintId, 'project' => $project, 'owner' =>$owner, 'kanban_view' => 'ok', 'gantt_real' => 'ok'                  
        ));  
      return $redirect;
    }
  }